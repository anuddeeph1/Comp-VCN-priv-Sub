...
#resource "oci_core_security_list" "service_subnet_sec_list" {
#  compartment_id = oci_identity_compartment.AnudeepCompartment.id
#  display_name   = "service_subnet_sec_list"
#  vcn_id         = oci_core_vcn.my_vcn.id
#
#
#  egress_security_rules {
...
#  compartment_id             = oci_identity_compartment.AnudeepCompartment.id
#  vcn_id                     = oci_core_vcn.my_vcn.id
#  display_name               = "service_subnet"
#  security_list_ids          = [oci_core_vcn.my_vcn.default_security_list_id, oci_core_security_list.service_subnet_sec_list.id]
#  route_table_id             = oci_core_route_table.my_rt_via_natgw_and_sg.id
#  prohibit_public_ip_on_vnic = true
#}
...
resource "oci_core_subnet" "my_lb_subnet" {
  ...
  # securityi_list_ids = [oci_core_vcn.my_vcn.default_security_list_id]
  route_table_id    = oci_core_route_table.AnudeepRouteTableViaIGW.id
...
#  security_list_ids = [oci_core_vcn.my_vcn.default_security_list_id, oci_core_security_list.AnudeepOKESecurityList.id]
#  route_table_id    = oci_core_route_table.AnudeepRouteTableViaIGW.id
#}
